import { INTERMISSION_SEC, REVEAL_BOARD_SEC, REVEAL_GUESSES_SEC, REVEAL_STING_SEC, ROUND_PHASES, type RoundPhase } from '@viraloderegal/shared';
...
// The clip phase runs for the round's actual segment length so guessing stays closed until playback ends;
// guess uses the game's configured timer; the reveal sub-phases and intermission use their shared constants.
