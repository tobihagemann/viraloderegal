import { INTERMISSION_SEC, PREPARE_SEC, REVEAL_BOARD_SEC, REVEAL_GUESSES_SEC, REVEAL_STING_SEC, ROUND_PHASES, type RoundPhase } from '@viraloderegal/shared';
...
// configured timer; the reveal sub-phases and intermission use their shared constants.
